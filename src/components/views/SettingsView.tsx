...
export function SettingsView() {
  return (
    <div className="flex-1 overflow-y-auto animate-in fade-in duration-200">
      <div className="p-5 max-w-[680px] flex flex-col gap-5">
        {/* Locations Card */}
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-4">
            <Filter size={16} className="text-[hsl(210,100%,40%)]" />
        ...
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-3">
            <Settings size={16} className="text-[hsl(210,100%,40%)]" />
          ...
          {[
            ...
            <div key={i} className="flex justify-between items-center py-3 border-b border-border">
              ...
              <span className="text-sm text-[hsl(210,100%,40%)] font-medium">{item.value}</span>
            </div>
          ))}
        </Card>
      </div>
